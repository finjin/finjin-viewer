...
LDLIBSOPTIONS=-L/home/build/finjin-3rd-party/cpp/boost/stage/lib -L/home/build/finjin-3rd-party/cpp/curl/lib ../../../finjin-engine/cpp/library/project/linux-netbeans/dist/Debug/GNU-Linux/libfinjin-engine.a ../../../finjin-common/cpp/library/project/linux-netbeans/dist/Debug/GNU-Linux/libfinjin-common.a -lpthread -lxcb -lxcb-keysyms -lxcb-ewmh -lxcb-xinerama -lxcb-randr -lboost_system -lboost_filesystem -lboost_thread -lboost_regex -lboost_chrono -lboost_timer -lboost_locale -lboost_program_options -lboost_log -lcurl -lrt -ldl -lX11 -lopenal
...
# Subprojects
.build-subprojects:
	cd ../../../finjin-engine/cpp/library/project/linux-netbeans && ${MAKE}  -f Makefile CONF=Debug
	cd ../../../finjin-common/cpp/library/project/linux-netbeans && ${MAKE}  -f Makefile CONF=Debug
...
# Subprojects
.clean-subprojects:
	cd ../../../finjin-engine/cpp/library/project/linux-netbeans && ${MAKE}  -f Makefile CONF=Debug clean
	cd ../../../finjin-common/cpp/library/project/linux-netbeans && ${MAKE}  -f Makefile CONF=Debug clean
